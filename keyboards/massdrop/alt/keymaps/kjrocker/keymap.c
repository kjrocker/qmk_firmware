...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_QWERTY] = LAYOUT(
        ...
        KC_ESC,  KC_A,    KC_SCLN, KC_H,    KC_Y,    KC_U,    KC_J,    KC_C,    KC_V,    KC_P,    KC_Z,    KC_Q,             KC_ENT,  KC_PGUP, \
    ...
    [_FNKEYS] = LAYOUT(
        ...
        _______, L_PSD,   L_BRI,   L_PSI,   L_T_BR,  _______, _______, _______, U_T_AGCR,_______, KC_PSCR, KC_SLCK, KC_PAUS, TG_NUMP, KC_END, \
        KC_CAPS, L_PTP,   L_BRD,   L_PTN,   L_T_PTD, _______, _______, _______, _______, _______, _______, _______,          _______, KC_VOLU, \
        _______, L_T_MD,  L_T_ONF, _______, _______, MD_BOOT, NK_TOGG, DBG_TOG, QWERTY , DVORAK , _______, _______,          KC_PGUP, KC_VOLD, \
